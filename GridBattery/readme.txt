...
Localization
The mod includes English, Russian, and 31 additional localizations. The selected translation is loaded from an embedded flat [key, value] JSON catalog during prototype registration; unsupported cultures fall back to English. Change the game language, then restart or reload the mod/game so the prototypes are registered again.
