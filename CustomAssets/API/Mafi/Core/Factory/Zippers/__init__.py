...
class MiniZipperValidator:
    def __init__(self):
        self.Priority = None

class MiniZipperProto:
    def __init__(self):
...
class Zipper:
    ...
    def __init__(self):
        self.CanBePaused = False
        self.TotalQuantityInBuffers = None
        self.QuantityInInputBuffer = None
        self.ForceEvenInputs = False
        self.QuantityInOutputBuffer = None
        self.MaxBufferSize = None
        self.ForceEvenOutputs = False
        self.IsEmpty = False
        self.IsGeneralPriorityVisible = False
        from Mafi import Option
        self.ElectricityConsumer = Option()
        self.IsPortPrioritizedArray = None
...
class ZipBuffProduct:
    def __init__(self):
        self.ProductQuantity = None
        self.EnqueuedAtStep = None

class ZipperConfigExtensions:
    def __init__(self):
        pass


class ZipperSetPriorityPortsCmd:
    def __init__(self):
        ...
        self.ZipperId = None
        self.PortName = None
        self.IsPrioritized = None

class ZipperSetForceEvenInputsCmd:
    def __init__(self):
        self.AffectsSaveState = False
        self.IsProcessed = False
        self.IsProcessedAndSynced = False
...
class ZipperSetForceEvenOutputsCmd:
    def __init__(self):
        self.AffectsSaveState = False
        self.IsProcessed = False
        self.IsProcessedAndSynced = False
